...
GRIDS["small_field"] = [
    ...
    [ROAD, SWAMP, ROCK, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROAD],
    [ROAD, GRASS, SWAMP, SWAMP, ROCK, ROAD, ROAD, SWAMP, SWAMP, ROAD],
    [ROAD, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROAD, ROAD, ROAD, GRASS],
    [GRASS, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROCK, ROAD, GRASS],
    [GRASS, ROAD, ROCK, ROCK, ROCK, GRASS, ROCK, ROAD, ROAD, GRASS],
...
GRIDS["large_field"] = [
    ...
    [SWAMP, GRASS, GRASS, GRASS, ROAD, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, GRASS, ROCK, GRASS, GRASS, GRASS, GRASS, ROAD, GRASS, ],
    [SWAMP, GRASS, GRASS, GRASS, ROAD, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROCK, GRASS, GRASS, GRASS, GRASS, ROAD, ROAD, ],
    [SWAMP, SWAMP, SWAMP, SWAMP, ROAD, GRASS, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROAD, ROCK, ROCK, ROCK, GRASS, ROAD, ROAD, ROAD, GRASS, ],
    [SWAMP, SWAMP, SWAMP, GRASS, ROAD, GRASS, GRASS, SWAMP, SWAMP, SWAMP, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROAD, ROCK, ROCK, ROCK, GRASS, GRASS, ROAD, ROAD, GRASS, ],
    [SWAMP, SWAMP, SWAMP, GRASS, ROAD, GRASS, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, GRASS, ROAD, ROCK, GRASS, GRASS, GRASS, GRASS, GRASS, ROAD, GRASS, ],
    ...
    [ROCK, ROCK, GRASS, GRASS, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, GRASS, GRASS, SWAMP, GRASS, ROAD, ROAD, ROAD, ROAD, ROAD, GRASS, GRASS, ROCK, ROCK, GRASS, GRASS, GRASS, ROAD, ],
    [GRASS, GRASS, GRASS, GRASS, ROCK, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, GRASS, GRASS, GRASS, ROAD, ROAD, ROAD, ROAD, GRASS, GRASS, ROAD, ROAD, GRASS, GRASS, ROCK, GRASS, GRASS, ROAD, ROAD, ],
    [GRASS, ROAD, GRASS, GRASS, ROCK, SWAMP, ROCK, SWAMP, SWAMP, GRASS, GRASS, ROAD, ROAD, ROAD, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, ROAD, GRASS, GRASS, ROAD, ROAD, ROAD, ROAD, GRASS, ],
